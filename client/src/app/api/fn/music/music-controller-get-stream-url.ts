...
export function musicControllerGetStreamUrl(http: HttpClient, rootUrl: string, params: MusicControllerGetStreamUrl$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
