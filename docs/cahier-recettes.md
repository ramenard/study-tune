...
| F-07 | Génération d'une fiche (PDF) | Connecté, `MISTRAL_API_KEY` | Importer un PDF → « Générer la fiche » | Fiche générée à partir du PDF | Fonctionnel | À rejouer | — |
...
| F-14 | Bibliothèque — télécharger | Un morceau prêt | Cliquer « télécharger » | Fichier audio téléchargé | Fonctionnel | À rejouer | — |
...
| S-04 | Rate limiting login | — | Rafale de requêtes sur `/api/auth/login` | 429 après 5 requêtes/min | Sécurité | À rejouer | — |
