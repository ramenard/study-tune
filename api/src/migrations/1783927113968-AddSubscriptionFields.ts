...
export class AddSubscriptionFields1783927113968 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD "generationsUsed" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "user" ADD "periodStart" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
    }
